package cn.demo.app.cms.commons.core;


import cn.demo.app.cms.commons.ig.RedisIdGenerator;
...
public class DubboRpcCmsMainLauncher {
    ...
    public void init() {
        ...
        //通过POJO类创建表结构
        try {
            Daos.createTablesInPackage(dao, "cn.demo.app.cms", false);
            //通过POJO类修改表结构
            //Daos.migration(dao, "cn.demo.app.cms", true, false);
        } catch (Exception e) {
        }
        //初始化主键值到redis
        //initRedisIg();
