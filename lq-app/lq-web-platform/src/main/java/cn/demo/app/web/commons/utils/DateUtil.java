package cn.demo.app.web.commons.utils;
...
public class DateUtil {
     ...
     * @return
     */
    public static long getYMDTime(String date) {
        try {
            return Times.parse(sdfYMD, date).getTime() / 1000;
        } catch (ParseException e) {
            return 0;
        }
    }
